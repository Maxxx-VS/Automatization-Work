...
def ext():
    ...
    list = ['Вальцы И-2222Б :: Гибка на вальцах', 'FG evo 2000 :: Сверление отверстий, фрезерование, маркировка', 'Дрель ручная :: Сверление отверстий', 'Листогиб :: Гибка', 'Машина для правки уголка ASM200 :: Правка',
    ...
    list_2 = ['Voortman V304', 'Гильотина', 'Пила ленточная', 'Пресс', 'Уголковая линия 2030AA', 'Уголковая линия VP-164 8D', 'Уголковая линия VP-184 6D',
              'Уголковая линия VPX-94 2G', 'Установка лазерной резки', 'Машина для термической резки труб "Орбита"']
